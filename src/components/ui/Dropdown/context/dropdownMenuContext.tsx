...
type DropdownMenuContextType = Partial<{
  open: boolean;
  items: any[];
  activeItemIndex: number | null;
  registerItem: (element?: HTMLElement | null, props?: object) => void;
...
export function useDropdownMenuContext(menuRef?: any): DropdownMenuContextType {
