...
const NextMore = ({ className, onArrow }: ArrowProps) => {
...
const PrevMore = ({ className, onArrow }: ArrowProps) => {
...
export type PaginationChangeHandler = (page: PaginationState) => void;
...
type PagerProps = {
  ...
  pagerClass: StatefulStyle;
};

const Pagers = (props: PagerProps) => {
  ...
  const onPagerClick = (value: number, e: MouseEvent<HTMLLIElement>) => {
    e.preventDefault();
    let newPage = value;
