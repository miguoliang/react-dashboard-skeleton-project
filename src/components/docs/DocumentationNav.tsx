...
import { Nav } from "../../views/docs/Documentations/documentationRoutes";

type NavContentProps = {
  onLinkClick?: FunctionType;
  routes: Nav;
};
...
const MobileNav = ({ routes }: { routes: Nav }) => {
...
const DocumentationNav = ({ routes }: { routes: Nav }) => {
  return (
