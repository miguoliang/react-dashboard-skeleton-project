...
import { Avatar, Button, ScrollBar } from "components/ui";
...
const MailList = () => {
  ...
  const loading = useAppSelector((state) => state.crmMail.data.mailListLoading);
  ...
  const onMailClick = (e: MouseEvent, id: number) => {
    e.stopPropagation();
        ...
        >
          {mails.map((mail) => (
            ...
            >
              <div
                className={`${
                  mailId === mail.id ? "bg-gray-50 dark:bg-gray-700" : ""
