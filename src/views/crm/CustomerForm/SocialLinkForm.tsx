...
const SocialLinkForm = (props: {
  ...
  return (
    <>
      <FormItem
        label="Facebook link"
        invalid={Boolean(errors.facebook && touched.facebook)}
      ...
      <FormItem
        label="Twitter link"
        invalid={Boolean(errors.twitter && touched.twitter)}
      ...
      <FormItem
        ...
        invalid={Boolean(errors.pinterest && touched.pinterest)}
      ...
      <FormItem
        label="LinkedIn link"
        invalid={Boolean(errors.linkedIn && touched.linkedIn)}
