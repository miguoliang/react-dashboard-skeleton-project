  ...
  return (
    <>
      <p>
        ...
        by accessing <code>src/configs/navigation.config/index.js</code>
      </p>
      ...
      <SyntaxHighlighter language="js">{`const navigationConfig = [
    {
      ...
      <div className="mt-10" id="configuringNavigationIcon">
        ...
        <p className="mt-1">
          ...
          <code>src/configs/navigation-icon.config.js</code>
        </p>
        <p>
          ...
          <code>navigation-icon.config.js</code> to define the icon for the
          callout.
        </p>
        <p>
