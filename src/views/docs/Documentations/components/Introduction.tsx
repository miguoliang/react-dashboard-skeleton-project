  ...
  return (
    <>
      <div id="introduction" className="mb-8">
        <p>
          Elstar is a complete React admin template with developer experience
        ...
        <p>
          Elstar offers several themes and layout options that allow you to
      ...
      <div id="coreLibrary">
        ...
        <ul>
          ...
          <li>
            ...
            <p className="mt-0">
              React build tools & setup with no configuration.
            </p>
          </li>
          <li>
            <a
