  ...
  return (
    <>
      ...
      <ol>
        <li>
          <p>
            First, create a <code>xxxService.js</code> file(depends on your
            feature or module) under <code>services</code> directory
          </p>
        </li>
        <li>
          <p>
            Declare an async function returning{" "}
            <code>ApiService.fetchData</code> method and pass in your api
            configuration details as the code below:
          </p>
      ...
      <div className="mt-10" id="proxying">
        ...
        <ul>
          ...
          <li>
            ...
            <p className="mt-1">
              You can choose to setup with <code>http-proxy-middleware</code>{" "}
              for more flexible configuration.
            </p>
            <p>
              Create <code>setupProxy.js</code> and place under{" "}
              <code>src/</code> directory with code following code:
            </p>
