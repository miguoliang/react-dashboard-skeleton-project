...
const Layouts = () => {
  return (
    <>
      <p>
        Elstar provide 6 types of app layouts & 3 types of auth layouts, all
      ...
      <div className="mt-10" id="configuringLayout">
        <div className="mt-10" id="classic">
          ...
          <p className="mt-1">
            ...
            <code>src/configs/theme.config.js</code> with the string value above
          </p>
    ...
    layout: {
        ...
        <ol>
          <li>
            <div id="classic">
              ...
              <ul>
                <li>
                  <strong>View</strong> - <code>src/views/index.js</code>
                </li>
                <li>
                  <strong>Header</strong> -{" "}
                  <code>src/components/template/Header.js</code>
                </li>
                <li>
                  <strong>SideNavToggle</strong> -{" "}
                  <code>src/components/template/SideNavToggle.js</code>
                </li>
                <li>
                  <strong>Search</strong> (optional) -{" "}
                  <code>src/components/template/Search.js</code>
                </li>
                <li>
                  <strong>LanguageSelector</strong> (optional) -{" "}
                  <code>src/components/template/LanguageSelector.js</code>
                </li>
                <li>
                  <strong>Notification</strong> (optional) -{" "}
                  <code>src/components/template/Notification.js</code>
                </li>
                <li>
                  <strong>SidePanel</strong> (optional) -{" "}
                  <code>src/components/template/SidePanel/index.js</code>
                </li>
                <li>
                  <strong>UserDropdown</strong> -{" "}
                  <code>src/components/template/UserDropdown.js</code>
                </li>
                <li>
                  <strong>SideNav</strong> -{" "}
                  <code>src/components/template/SideNav.js</code>
                </li>
                <li>
                  <strong>MobileNav</strong> -{" "}
                  <code>src/components/template/MobileNav.js</code>
                </li>
              </ul>
            </div>
          </li>
            ...
            <div id="stackedSide">
              ...
              <ul>
                ...
                <li>
                  ...
                  <code>src/components/template/SplittedSideNav.js</code>
                </li>
                <li>
                  <strong>MobileNav</strong> -{" "}
                  <code>src/components/template/MobileNav.js</code>
            ...
            <div id="Simple">
              ...
              <ul>
                ...
                <li>
                  ...
                  <code>src/components/template/HeaderLogo.js</code>
                </li>
                <li>
                  <strong>HorizontalNav</strong> -{" "}
                  <code>src/components/template/HorizontalNav.js</code>
                </li>
                <li>
                  <strong>Search</strong> (optional) -{" "}
                  <code>src/components/template/Search.js</code>
            ...
            <div id="Decked">
              ...
              <ul>
                ...
                <li>
                  ...
                  <code>src/components/template/SecondaryHeader.js</code>
                </li>
                <li>
                  <strong>Search</strong> (optional) -{" "}
                  <code>src/components/template/Search.js</code>
      ...
      <div className="mt-10" id="overridingLayouts">
        ...
        <p className="mt-1">
          ...
          <code>theme.config.js</code>. However, if there are some cases where
        ...
        <SyntaxHighlighter language="js">{`export const protectedRoutes = [
    {
      ...
      <div className="mt-10" id="authLayouts">
        ...
        <p>
          ...
          need to visit <code>src/components/layout/AuthLayout/index.js</code>{" "}
