  ...
  return (
    <>
      ...
      <p>
        ...
        <code>src/store/</code>, there's also several slice globally used as
        following:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        to keep <code>auth</code> & <code>theme</code> state alive in
        localStorage.
      </p>
...
export default yourSlice.reducer`}</SyntaxHighlighter>
      ...
      <p>
        Here's also another example for <code>extrareducers</code> as an object:
      </p>
