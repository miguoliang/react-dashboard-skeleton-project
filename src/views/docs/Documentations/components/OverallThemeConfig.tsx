...
const OverallThemeConfig = () => {
  return (
    <>
      <p>
        <code>src/configs/theme.config.js</code> has all template configurations
    ...
    layout: {
      ...
      <div className="mt-10" id="properties">
        ...
        <p>
          ...
          you can visit <code>src/store/theme/themeSlice.js</code> & remove the
          field you don't wish to persist from the <code>initialState</code>.
        </p>
