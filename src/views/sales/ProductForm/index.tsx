...
const DeleteProductButton = ({
  ...
  onDelete?: (setDialogOpen: (isOpen: boolean) => void) => void;
}) => {
...
const ProductForm = forwardRef<
  FormikProps<any>,
  {
    ...
    onDiscard?: () => void;
    onDelete?: (setDialogOpen: (arg0: boolean) => void) => void;
  }
>((props, ref) => {
  const {
    type = "edit",
      ...
      <Formik
        ...
        initialValues={{
          ...
          tags: initialData?.tags
            ? initialData.tags.map((value: string) => ({
                label: value,
                value,
              }))
            : [],
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          formData.tags = formData.tags.map(
