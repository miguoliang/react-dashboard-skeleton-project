...
import { Product, ProductImage } from "../../../mock/data/salesData";

const ImageList = (props: {
  imgList: ProductImage[];
  onImageDelete?: (img: ProductImage) => void;
}) => {
  ...
  const onViewOpen = (img: ProductImage) => {
    setSelectedImg(img);
    setViewOpen(true);
  };
  ...
  const onDeleteConfirmation = (img: ProductImage) => {
    setSelectedImg(img);
  ...
  const onDelete = () => {
    selectedImg && onImageDelete?.(selectedImg);
    setDeleteConfirmationOpen(false);
  };
...
const ProductImages = (props: {
  ...
  const beforeUpload = (file: File[] | FileList) => {
