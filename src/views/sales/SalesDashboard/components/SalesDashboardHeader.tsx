...
import { Button, DatePickerRange } from "components/ui";
import { setEndDate, setStartDate } from "../store/stateSlice";
...
const SalesDashboardHeader = () => {
  ...
  const endDate = useAppSelector((state) => state.salesDashboard.state.endDate);
