...
import { OrderDetails, OrderDetailsProduct } from "mock/data/salesData";

const TFootRows = ({ label, value }: { label: string; value: number }) => {
  return (
    <Tr>
...
const ContentTable = ({
  ...
  summary: OrderDetails["paymentSummary"];
}) => {
    ...
    () => [
      {
        header: "Product",
        accessorKey: "name",
        cell: (props: { row: { original: OrderDetailsProduct } }) => {
