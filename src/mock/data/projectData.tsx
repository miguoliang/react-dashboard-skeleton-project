...
export type ProjectDashboard = {
  ...
  taskCount: number;
  projectOverviewData?: {
    chart: Record<string, ProjectDashboardOverview>;
  };
  myTasksData?: Task[];
  scheduleData?: Schedule[];
  projectsData?: Project[];
  activitiesData?: ProjectActivity[];
};
...
export const projectDashboardData: ProjectDashboard = {
  ...
  scheduleData: [
    ...
    },
    {
      ...
      description: "via Microsoft Teams",
      type: "meeting",
    },
    {
      id: "2",
...
export const scrumBoardData: Column[] = [
  { order: "To Do", cards: toBeProcessCards },
  { order: "In Progress", cards: processingCards },
  { order: "Submitted", cards: submittedCards },
  { order: "Completed", cards: completedCards },
];
